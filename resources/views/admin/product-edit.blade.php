        ...
        <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data"
            ...
            <div class="wg-box">
                ...
                <fieldset class="shortdescription">
                    ...
                    <div class="text-tiny">Do not exc   eed 100 characters when entering the
                        product name.</div>
                </fieldset>
...
<script>
    $(document).ready(function(){
        ...
        $("input[name='images[]']").on("change", function(){
            $("#galUpload").siblings('.gitems').remove(); // Hapus pratinjau gambar galeri sebelumnya
            $("#gallery-error").hide();
            ...
            if (files.length > 2) {
                ...
                $.each(files, function(index, file){
                    ...
                    reader.onload = function(e){
                        ...
                        var div = $('<div>').addClass('item gitems').append(img);
                        $("#galUpload").before(div); // Tambahkan gambar sebelum elemen #galUpload
                    }
